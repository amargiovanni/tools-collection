...
export const toolRegistry: readonly ToolMeta[] = [
  ...
  },
  {
    ...
    category: 'generators',
    icon: '🗝️',
    keywords: ['passphrase', 'phrase', 'words', 'seed', 'generate', 'random'],
  ...
  },
  {
    ...
    category: 'generators',
    icon: '🎲',
    keywords: ['random', 'string', 'token', 'id', 'secret', 'generate'],
  ...
  },
  {
    ...
    category: 'generators',
    icon: '🔐',
    keywords: ['api', 'key', 'secret', 'token', 'prefix', 'generate'],
  ...
  },
  {
    ...
    category: 'generators',
    icon: '🧾',
    keywords: ['jwt', 'secret', 'key', 'token', 'generate', 'base64url'],
  ...
  },
  {
    ...
    category: 'security',
    icon: '🗝️',
    keywords: ['aes', 'key', 'encryption', 'secret', 'hex', 'base64', 'generate'],
    path: '/tools/aes-key-generator',
  },
  {
    id: 'hmac-key-generator',
    category: 'security',
    icon: '🧪',
    keywords: ['hmac', 'key', 'secret', 'hash', 'sign', 'generate'],
    path: '/tools/hmac-key-generator',
  },
  {
    id: 'salt-generator',
    category: 'security',
    icon: '🧂',
    keywords: ['salt', 'hash', 'secret', 'generate', 'random'],
    path: '/tools/salt-generator',
  },
  {
    id: 'recovery-code-generator',
    category: 'security',
    icon: '🧯',
    keywords: ['recovery', 'backup', 'codes', '2fa', 'mfa', 'generate'],
    path: '/tools/recovery-code-generator',
  },
