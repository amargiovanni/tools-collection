...
export const toolComponents: Record<string, ToolComponent> = {
  ...
  'passphrase-generator': lazy(() => import('../components/tools/PassphraseGenerator')),
  'random-string-generator': lazy(() => import('../components/tools/RandomStringGenerator')),
  'api-key-generator': lazy(() => import('../components/tools/ApiKeyGenerator')),
  'jwt-secret-generator': lazy(() => import('../components/tools/JwtSecretGenerator')),
  ...
  'aes-key-generator': lazy(() => import('../components/tools/AesKeyGenerator')),
  'hmac-key-generator': lazy(() => import('../components/tools/HmacKeyGenerator')),
  'salt-generator': lazy(() => import('../components/tools/SaltGenerator')),
  'recovery-code-generator': lazy(() => import('../components/tools/RecoveryCodeGenerator')),
  ...
  'sort-text': lazy(() => import('../components/tools/SortText')),
  'docker-run-to-compose': lazy(() => import('../components/tools/DockerRunToCompose')),
  'date-interval': lazy(() => import('../components/tools/DateInterval')),
